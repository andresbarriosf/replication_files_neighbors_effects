...
*** Figure C1  *****************************************************************
#delimit;
rddensity score_rd_o if Sample == 1 & score_rd_o >-475, c(0) p(2) q(3)
...
foreach var of varlist `my_vars1'{
    ...
    coefficients_for_plots `var' score_rd_o cutoff_o uni_o 1 `bw11' `bw21' "& Sample == 1" family psu_year_y "rf" `counter' "`vtext1'"
}

coefficients_plots "rf" "horizontal" "figureC4a" cutoff_o uni
estimates drop _all
...
coefficients_plots "rf" "horizontal" "figureC4b" cutoff_o uni
estimates drop _all
...
#delimit;
rdrobust uni_o score_rd_y if  uni_o !=. & Sample == 1,
...
coefficients_plots "rf" "vertical" "figureC7b" cutoff_aux uni
estimates drop _all
...
coefficients_plots "iv" "vertical" "figureC9" cutoff_o uni_o
estimates drop _all
...
reduced_form_plot uni_y      1 score_rd_sch cutoff_sch  `bwA' `bwB' 5 5.5 "& Sample == 1" family psu_year_y 9 "figureD2a"
reduced_form_plot applyFA_y  1 score_rd_sch cutoff_sch  `bwA' `bwB' 5 5.5 "& Sample == 1" family psu_year_y 9 "figureD2b"
reduced_form_plot uni_o      1 score_rd_sch cutoff_sch  `bwA' `bwB' 5 5.5 "& Sample == 1" family psu_year_y 9 "figureD2c"
reduced_form_plot loans      1 score_rd_sch cutoff_sch  `bwA' `bwB' 5 5.5 "& Sample == 1" family psu_year_y 9 "figureD2d"
