...
#delimit;
local stat_neighbours psu_female psu_age lowIncome midIncome highIncome 
pe_n1 pe_n2 pe_n3 pe_n4 pe_n5 pe_n6
private_hi_n public_hi_n  public_n charter_n private_n hc tp
g12_gpa g9_gpa score_rd single  work live_parents_n
live_relatives_n live_independently_n family_group hh_father_n hh_mother_n
hh_applicant_n;
#delimit cr
...
g9_gpa_o g12_gpa_o score_rd_o  single_o  work_o live_parents_o
live_relatives_o live_independently_o family_group_o hh_father_o hh_mother_o
hh_applicant_o km_to_code;
#delimit cr
...
eststo: estpost tabstat `stat_neighbours' `stat_applicants' if score_rd >= -`bw11' & score_rd <= `bw21', stat(mean) col(stat)
est sto m1
